  ...
  return (
    <div className="Works">
      ...
      <div className="awesome">
        ...
        <spane>
          <li>
            Davis is a programmer with all the
          ...
          <li>
            Great contributer to OPENMRS, an open source software <br />
            platform (write code save lives). Find it here{" "}
            <a href="https://openmrs.org">Openmrs</a>{" "}
          </li>
        </spane>
